...
Page {
    ...
    Rectangle {
        ...
        Row {
            ...
            NavigationButton { onClicked: fbWebview.setUrl("https://m.facebook.com/groups_browse/your_groups"); notifyIndicator: app.notifications[6]; iconSource: "qrc:///images/icon-groups.svg"; visible: settings.showGroups }
